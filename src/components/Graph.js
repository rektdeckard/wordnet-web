...
const Graph = () => {
  return (
    ...
    >
      <ForceGraphNode
        node={{ id: 1, label: "smart" }}
        fill="blue"
      />
      <ForceGraphNode
        node={{ id: 2, label: "knowledge" }}
        fill="red"
      />
      <ForceGraphLink link={{ source: 1, target: 2 }} />
      <ForceGraphNode
        node={{ id: 3, label: "capacity" }}
        fill="red"
      />
      <ForceGraphLink link={{ source: 2, target: 3 }} />
      <ForceGraphNode
        node={{ id: 4, label: "types" }}
        fill="red"
      />
      <ForceGraphLink link={{ source: 4, target: 2 }} />
      <ForceGraphNode
        node={{ id: 5, label: "information" }}
        fill="red"
      />
